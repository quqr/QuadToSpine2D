...
public static class PlatformConfigs
{
    ...
    private static List<SectionInfo> GetVer55Sections()
    {
        return
        [
            new SectionInfo(0x54, 0x20, [0x3c, 2]),
            new SectionInfo(0x58, 0x20, [0x3e, 2]),
            new SectionInfo(0x5c, 0x20, [0x40, 2]),
            new SectionInfo(0x60, 0x50, [0x44, 2]),
            new SectionInfo(0x64, 0x18, [0x42, 2]),
            new SectionInfo(0x68, 0x08, [0x46, 2]),
            new SectionInfo(0x6c, 0x18, [0x4c, 2]),
            new SectionInfo(0x70, 0x30, [0x48, 2]),
            new SectionInfo(0x74, 0x20, [0x4a, 2]),
            new SectionInfo(0x78, 0x30, [0x4e, 2]),
            new SectionInfo(0x7c, 0x08, [0x50, 2])
        ];
    }
    ...
    private static List<SectionInfo> GetVer66Sections()
    {
        return
        [
            new SectionInfo(0x54, 0x18, [0x3c, 2]),
            new SectionInfo(0x58, 0x30, [0x3e, 2]),
            new SectionInfo(0x5c, 0x30, [0x40, 2]),
            new SectionInfo(0x60, 0x50, [0x44, 2]),
            new SectionInfo(0x64, 0x0c, [0x42, 2]),
            new SectionInfo(0x68, 0x08, [0x46, 2]),
            new SectionInfo(0x6c, 0x18, [0x4c, 2]),
            new SectionInfo(0x70, 0x24, [0x48, 2]),
            new SectionInfo(0x74, 0x20, [0x4a, 2]),
            new SectionInfo(0x78, 0x30, [0x4e, 2]),
            new SectionInfo(0x7c, 0x10, [0x50, 2])
        ];
    }
    ...
    private static List<SectionInfo> GetVer6eSections()
    {
        return
        [
            new SectionInfo(0x74, 0x18, [0x54, 2]),
            new SectionInfo(0x78, 0x30, [0x56, 2]),
            new SectionInfo(0x7c, 0x30, [0x58, 2]),
            new SectionInfo(0x80, 0x50, [0x5a, 2]),
            new SectionInfo(0x84, 0x0c, [0x50, 4]),
            new SectionInfo(0x88, 0x08, [0x5c, 2]),
            new SectionInfo(0x8c, 0x1c, [0x64, 2]),
            new SectionInfo(0x90, 0x24, [0x5e, 2]),
            new SectionInfo(0x94, 0x20, [0x60, 2]),
            new SectionInfo(0x98, 0x30, [0x66, 2]),
            new SectionInfo(0x9c, 0x14, [0x68, 2])
        ];
    }
    ...
    private static List<SectionInfo> GetVer72Sections()
    {
        return
        [
            new SectionInfo(0xb0, 0x18, [0x54, 2]),
            new SectionInfo(0xb8, 0x30, [0x56, 2]),
            new SectionInfo(0xc0, 0x30, [0x58, 2]),
            new SectionInfo(0xc8, 0x50, [0x5a, 2]),
            new SectionInfo(0xd0, 0x10, [0x50, 4]),
            new SectionInfo(0xd8, 0x08, [0x5c, 2]),
            new SectionInfo(0xe0, 0x1c, [0x62, 2]),
            new SectionInfo(0xe8, 0x24, [0x5e, 2]),
            new SectionInfo(0xf0, 0x20, [0x60, 2]),
            new SectionInfo(0xf8, 0x30, [0x64, 2]),
            new SectionInfo(0x100, 0x18, [0x66, 2]),
            new SectionInfo(0x108, 0x14, [0x6a, 2])
        ];
    }
    ...
    private static List<SectionInfo> GetVer76Sections()
    {
        ...
        [
            ...
            new SectionInfo(0xc0, 0x30, [0x58, 2]),
            new SectionInfo(0xc8, 0x50, [0x5a, 2]),
            new SectionInfo(0xd0, 0x14, [0x50, 4]),
            new SectionInfo(0xd8, 0x08, [0x5c, 2]),
            new SectionInfo(0xe0, 0x1c, [0x62, 2]),
            new SectionInfo(0xe8, 0x24, [0x5e, 2]),
            new SectionInfo(0xf0, 0x20, [0x60, 2]),
    ...
    private static List<SectionInfo> GetVer77Sections()
    {
        return
        [
            new SectionInfo(0xb0, 0x18, [0x54, 4]),
            new SectionInfo(0xb8, 0x30, [0x58, 4]),
            new SectionInfo(0xc0, 0x30, [0x5c, 4]),
            new SectionInfo(0xc8, 0x50, [0x60, 4]),
            new SectionInfo(0xd0, 0x14, [0x50, 4]),
            new SectionInfo(0xd8, 0x08, [0x64, 2]),
            new SectionInfo(0xe0, 0x1c, [0x6a, 2]),
            new SectionInfo(0xe8, 0x24, [0x66, 2]),
            new SectionInfo(0xf0, 0x20, [0x68, 2]),
            new SectionInfo(0xf8, 0x30, [0x6c, 2]),
            new SectionInfo(0x100, 0x18, [0x6e, 2]),
            new SectionInfo(0x108, 0x14, [0x72, 2])
        ];
    }
}